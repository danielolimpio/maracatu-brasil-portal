...
const SLUG = "bpc-loas-2026-quem-tem-direito-valor-como-solicitar";
const URL = `${SITE}/beneficios/${SLUG}`;

export const Route = createFileRoute("/beneficios/bpc-loas-2026-quem-tem-direito-valor-como-solicitar")({
  loader: () => {
