...
const SLUG = "seguro-desemprego-2026-quem-tem-direito-parcelas-valor";
const URL = `${SITE}/empregos/${SLUG}`;

export const Route = createFileRoute("/empregos/seguro-desemprego-2026-quem-tem-direito-parcelas-valor")({
  loader: () => {
