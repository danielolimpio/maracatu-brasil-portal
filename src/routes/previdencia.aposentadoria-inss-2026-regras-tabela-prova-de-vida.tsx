...
const SLUG = "aposentadoria-inss-2026-regras-tabela-prova-de-vida";
const URL = `${SITE}/previdencia/${SLUG}`;

export const Route = createFileRoute("/previdencia/aposentadoria-inss-2026-regras-tabela-prova-de-vida")({
  loader: () => {
