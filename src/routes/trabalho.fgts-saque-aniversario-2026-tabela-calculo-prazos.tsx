...
const SLUG = "fgts-saque-aniversario-2026-tabela-calculo-prazos";
const URL = `${SITE}/trabalho/${SLUG}`;

export const Route = createFileRoute("/trabalho/fgts-saque-aniversario-2026-tabela-calculo-prazos")({
  loader: () => {
