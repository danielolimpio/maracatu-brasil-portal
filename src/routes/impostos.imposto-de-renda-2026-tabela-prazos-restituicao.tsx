...
const SLUG = "imposto-de-renda-2026-tabela-prazos-restituicao";
const URL = `${SITE}/impostos/${SLUG}`;

export const Route = createFileRoute("/impostos/imposto-de-renda-2026-tabela-prazos-restituicao")({
  loader: () => {
